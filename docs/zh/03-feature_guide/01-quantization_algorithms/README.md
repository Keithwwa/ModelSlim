...
- [Flex Smooth Quant](flex_smooth_quant.md): 进阶方案。支持自动参数搜索，�?Iterative Smooth 效果不佳时尝试�?
- [Flex AWQ SSZ](flex_awq_ssz.md): 低比特必备。专�?INT4/W4A8 等场景设计，使用真实量化器评估误差�?
- [Iterative Smooth](iterative_smooth.md): 首选方案。运行快，精度较高，适用于绝大多�?W8A8 场景�?
